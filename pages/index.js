      ...
      <main className={styles.main}>
        ...
        <div className={styles.title_div}>
          <span className={styles.title}>
            The Tech Vault: Unlocking the Secrets of Technology and Development
          </span>
          <Link href="#latest">
            <div className={styles.btn_div}>
              <button className={styles.btn}>read latest blogs</button>
            </div>
          </Link>
        </div>
        <section className="text-gray-600 body-font" id="latest">
